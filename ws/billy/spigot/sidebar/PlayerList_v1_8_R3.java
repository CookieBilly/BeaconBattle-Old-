...
public class PlayerList_v1_8_R3 extends ScoreboardTeam implements PlayerList
{
    ...
    private Sidebar_v1_8_R3 sidebar;
    ...
    public PlayerList_v1_8_R3(@NotNull final Sidebar_v1_8_R3 sidebar, @NotNull final Player player, final SidebarLine prefix, final SidebarLine suffix) {
    ...
    public void addPlayer(final String o) {
        ...
        CustomScore_v1_8_R3.sendScore(this.sidebar, o, 20);
