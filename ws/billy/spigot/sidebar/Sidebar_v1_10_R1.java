...
class Sidebar_v1_10_R1 implements Sidebar
{
    ...
    private ConcurrentHashMap<String, PlayerList_v1_10_R1> teamLists;
    
    public Sidebar_v1_10_R1(@NotNull final SidebarLine sidebarLine, @NotNull final Collection<SidebarLine> collection, final Collection<PlaceholderProvider> c) {
        ...
        this.teamLists = new ConcurrentHashMap<String, PlayerList_v1_10_R1>();
    ...
    public void apply(final Player player) {
        ...
        if (this.healthObjective != null) {
            ...
            this.teamLists.forEach((p1, playerList_v1_10_R1) -> playerList_v1_10_R1.sendCreate(playerConnection));
        }
    }
    ...
    public void playerListCreate(@NotNull final Player player, final SidebarLine sidebarLine, final SidebarLine sidebarLine2) {
        ...
        final PlayerList_v1_10_R1 value = new PlayerList_v1_10_R1(this, player, sidebarLine, sidebarLine2);
    ...
    public void playerListAddPlaceholders(@NotNull final Player player, final PlaceholderProvider... array) {
        final PlayerList_v1_10_R1 playerList_v1_10_R1 = this.teamLists.getOrDefault(player.getName(), null);
        if (playerList_v1_10_R1 == null) {
            return;
        }
        for (int length = array.length, i = 0; i < length; ++i) {
            playerList_v1_10_R1.addPlaceholderProvider(array[i]);
        }
    ...
    public void playerListRemovePlaceholder(@NotNull final Player player, final String s) {
        ...
        playerList_v1_10_R1.removePlaceholderProvider(s);
        playerList_v1_10_R1.sendUpdate();
    }
    
    @Override
    public void playerListRemove(final String s) {
        final PlayerList_v1_10_R1 playerList_v1_10_R1 = this.teamLists.getOrDefault(s, null);
        if (playerList_v1_10_R1 != null) {
            this.players.forEach(playerList_v1_10_R1::sendRemove);
    ...
    public void playerListClear() {
        this.teamLists.forEach((p0, playerList_v1_10_R1) -> this.players.forEach(playerList_v1_10_R1::sendRemove));
    ...
    public void playerListHideNameTag(@NotNull final Player player) {
        final PlayerList_v1_10_R1 playerList_v1_10_R1 = this.teamLists.get(player.getName());
        if (playerList_v1_10_R1 != null) {
    ...
    public void refreshHealth(@NotNull final Player player, int n) {
        ...
        CustomScore_v1_10_R1.sendScore(this, player.getName(), n);
    }
    
    @Override
    public void playerListRefreshAnimation() {
        this.teamLists.forEach((p0, playerList_v1_10_R1) -> playerList_v1_10_R1.sendUpdate());
    }
    ...
    public void remove(final UUID obj) {
        ...
        if (player != null && player.isOnline()) {
            ...
            this.teamLists.forEach((p1, playerList_v1_10_R1) -> playerList_v1_10_R1.sendRemove(playerConnection2));
        }
    }
    ...
    private class SidebarObjective extends ScoreboardObjective
    {
        ...
        private void sendUpdate() {
            Sidebar_v1_10_R1.this.players.forEach(playerConnection -> playerConnection.sendPacket((Packet)new PacketPlayOutScoreboardObjective((ScoreboardObjective)this, 2)));
        }
        
        public void sendRemove(@NotNull final PlayerConnection playerConnection) {
            Sidebar_v1_10_R1.this.teamLists.forEach((p0, playerList_v1_10_R1) -> Sidebar_v1_10_R1.this.players.forEach(playerList_v1_10_R1::sendRemove));
    ...
    private class ScoreLine extends ScoreboardScore implements Comparable<ScoreLine>
    {
        ...
        public ScoreLine(final SidebarLine text, @NotNull final int score, final String s) {
            super((Scoreboard)null, (ScoreboardObjective)Sidebar_v1_10_R1.this.sidebarObjective, s);
            this.prefix = "";
            this.suffix = "";
            this.score = score;
            this.text = text;
            ...
            if (text.isHasPlaceholders()) {
                ...
                for (final PlaceholderProvider placeholderProvider2 : Sidebar_v1_10_R1.this.placeholderProviders) {
        ...
        private void remove() {
            ...
            Sidebar_v1_10_R1.this.players.forEach(playerConnection -> {
                ...
                packet2 = (Packet)new PacketPlayOutScoreboardScore(this.getPlayerName(), (ScoreboardObjective)Sidebar_v1_10_R1.this.sidebarObjective);
                playerConnection.sendPacket(packet);
                playerConnection.sendPacket(packet2);
                return;
            });
            Sidebar_v1_10_R1.this.availableColors.add(this.getColor());
            this.text = null;
            this.team = null;
            this.prefix = null;
            this.suffix = null;
        ...
        private void setContent(@NotNull String replacePlaceholders) {
            if (!Sidebar_v1_10_R1.this.players.isEmpty()) {
                replacePlaceholders = SidebarManager.getPapiSupport().replacePlaceholders((Player)Sidebar_v1_10_R1.this.players.get(0).getPlayer(), replacePlaceholders);
            }
        ...
        private void sendUpdate() {
            Sidebar_v1_10_R1.this.players.forEach(playerConnection -> playerConnection.sendPacket((Packet)new PacketPlayOutScoreboardTeam((ScoreboardTeam)this.team, 2)));
        }
        ...
        public void setScore(final int score) {
            this.score = score;
            Sidebar_v1_10_R1.this.players.forEach(playerConnection -> playerConnection.sendPacket((Packet)new PacketPlayOutScoreboardScore((ScoreboardScore)this)));
        }
