...
public class PlayerList_v1_11_R1 extends ScoreboardTeam implements PlayerList
{
    private SidebarLine prefix;
    private SidebarLine suffix;
    private Sidebar_v1_11_R1 sidebar;
    ...
    public PlayerList_v1_11_R1(@NotNull final Sidebar_v1_11_R1 sidebar, @NotNull final Player player, final SidebarLine prefix, final SidebarLine suffix) {
    ...
    public void addPlayer(final String o) {
        ...
        CustomScore_v1_11_R1.sendScore(this.sidebar, o, 20);
    ...
    public boolean equals(final Object o) {
        return this == o || o == null || (o instanceof PlayerList_v1_11_R1 && ((PlayerList_v1_11_R1)o).getName().equals(this.getName()));
    }
}
