...
package ws.billy.bedwars.support.version.v1_15_R1;

import net.minecraft.server.v1_15_R1.GenericAttributes;
import net.minecraft.server.v1_15_R1.SoundEffect;
import net.minecraft.server.v1_15_R1.ReputationEvent;
...
public class v1_15_R1 extends VersionSupport
{
    ...
    public v1_15_R1(final Plugin plugin, final String s) {
        super(plugin, s);
    ...
    private void spawnVillager(final Location location) {
        ...
        handle.addEntity((net.minecraft.server.v1_15_R1.Entity)villagerShop, CreatureSpawnEvent.SpawnReason.CUSTOM);
    }
    ...
    public void hideArmor(final Player player, final Player player2) {
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.MAINHAND, new net.minecraft.server.v1_15_R1.ItemStack((IMaterial)Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment2 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.OFFHAND, new net.minecraft.server.v1_15_R1.ItemStack((IMaterial)Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment3 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.HEAD, new net.minecraft.server.v1_15_R1.ItemStack((IMaterial)Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment4 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.CHEST, new net.minecraft.server.v1_15_R1.ItemStack((IMaterial)Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment5 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.LEGS, new net.minecraft.server.v1_15_R1.ItemStack((IMaterial)Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment6 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.FEET, new net.minecraft.server.v1_15_R1.ItemStack((IMaterial)Item.getById(0)));
    ...
    public void showPlayer(final Player player, final Player player2) {
        ...
        if (player.getLocation().distanceSquared(player2.getLocation()) <= v1_15_R1.renderDistance) {
    ...
    public ItemStack getPlayerHead(final Player player, final ItemStack itemStack) {
        ...
        if (itemStack != null) {
            final net.minecraft.server.v1_15_R1.ItemStack nmsCopy = CraftItemStack.asNMSCopy(bukkitCopy);
    ...
    public void invisibilityFix(final Player obj, final IArena arena) {
        ...
        for (final Player player : arena.getPlayers()) {
            ...
            if (player.getLocation().distance(obj.getLocation()) > v1_15_R1.renderDistance) {
                continue;
            }
    ...
    public static class VillagerShop extends EntityVillager
    {
        ...
        public void collide(final net.minecraft.server.v1_15_R1.Entity entity) {
        }
        ...
        public void a(final ReputationEvent reputationEvent, final net.minecraft.server.v1_15_R1.Entity entity) {
        }
