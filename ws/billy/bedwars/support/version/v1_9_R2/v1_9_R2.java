...
import net.minecraft.server.v1_9_R2.IProjectile;
...
public class v1_9_R2 extends VersionSupport
{
    ...
    public v1_9_R2(final Plugin plugin, final String s) {
        super(plugin, s);
        try {
    ...
    private Villager spawnVillager(final Location location) {
        ...
        handle.addEntity((net.minecraft.server.v1_9_R2.Entity)villagerShop, CreatureSpawnEvent.SpawnReason.CUSTOM);
        return (Villager)villagerShop.getBukkitEntity();
    }
    ...
    public void hideArmor(final Player player, final Player player2) {
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.MAINHAND, new net.minecraft.server.v1_9_R2.ItemStack(Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment2 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.OFFHAND, new net.minecraft.server.v1_9_R2.ItemStack(Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment3 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.HEAD, new net.minecraft.server.v1_9_R2.ItemStack(Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment4 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.CHEST, new net.minecraft.server.v1_9_R2.ItemStack(Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment5 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.LEGS, new net.minecraft.server.v1_9_R2.ItemStack(Item.getById(0)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment6 = new PacketPlayOutEntityEquipment(player.getEntityId(), EnumItemSlot.FEET, new net.minecraft.server.v1_9_R2.ItemStack(Item.getById(0)));
    ...
    public void hidePlayer(final Player player, final Player player2) {
        ...
        if (player.getLocation().distanceSquared(player2.getLocation()) <= v1_9_R2.renderDistance) {
    ...
    public ItemStack getPlayerHead(final Player player, final ItemStack itemStack) {
        ...
        if (itemStack != null) {
            final net.minecraft.server.v1_9_R2.ItemStack nmsCopy = CraftItemStack.asNMSCopy(bukkitCopy);
    ...
    public void invisibilityFix(final Player obj, final IArena arena) {
        ...
        for (final Player player : arena.getPlayers()) {
            ...
            if (player.getLocation().distance(obj.getLocation()) > v1_9_R2.renderDistance) {
                continue;
            }
    ...
    public class VillagerShop extends EntityVillager
    {
        ...
        public void collide(final net.minecraft.server.v1_9_R2.Entity entity) {
        }
