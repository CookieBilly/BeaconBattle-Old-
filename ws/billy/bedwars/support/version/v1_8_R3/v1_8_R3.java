...
public class v1_8_R3 extends VersionSupport
{
    ...
    public v1_8_R3(final Plugin plugin, final String s) {
        super(plugin, s);
        try {
    ...
    public void playAction(final Player player, final String str) {
        ((CraftPlayer)player).getHandle().playerConnection.sendPacket((Packet)new PacketPlayOutChat(IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + str + "\"}"), (byte)2));
    }
    ...
    public boolean isSword(final ItemStack itemStack) {
        return CraftItemStack.asNMSCopy(itemStack).getItem() != null && CraftItemStack.asNMSCopy(itemStack).getItem() instanceof ItemSword;
    }
    ...
    @Override
    public void setCollide(final Player player, final IArena arena, final boolean collidesWithEntities) {
    ...
    private void registerEntity(final String s, final int i, final Class clazz) {
        try {
    ...
    private void spawnVillager(final Location location) {
        ...
        handle.addEntity((net.minecraft.server.v1_8_R3.Entity)villagerShop, CreatureSpawnEvent.SpawnReason.CUSTOM);
        villagerShop.getBukkitEntity();
    }
    ...
    public void hideArmor(final Player player, final Player player2) {
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment = new PacketPlayOutEntityEquipment(player.getEntityId(), 0, CraftItemStack.asNMSCopy(new ItemStack(Material.AIR)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment2 = new PacketPlayOutEntityEquipment(player.getEntityId(), 1, CraftItemStack.asNMSCopy(new ItemStack(Material.AIR)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment3 = new PacketPlayOutEntityEquipment(player.getEntityId(), 2, CraftItemStack.asNMSCopy(new ItemStack(Material.AIR)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment4 = new PacketPlayOutEntityEquipment(player.getEntityId(), 3, CraftItemStack.asNMSCopy(new ItemStack(Material.AIR)));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment5 = new PacketPlayOutEntityEquipment(player.getEntityId(), 4, CraftItemStack.asNMSCopy(new ItemStack(Material.AIR)));
        final PlayerConnection playerConnection = ((CraftPlayer)player2).getHandle().playerConnection;
    ...
    public void showPlayer(final Player player, final Player player2) {
        ...
        if (player.getLocation().distanceSquared(player2.getLocation()) <= v1_8_R3.renderDistance) {
    ...
    public void showArmor(final Player player, final Player player2) {
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment = new PacketPlayOutEntityEquipment(player.getEntityId(), 0, CraftItemStack.asNMSCopy(player.getItemInHand()));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment2 = new PacketPlayOutEntityEquipment(player.getEntityId(), 4, CraftItemStack.asNMSCopy(player.getInventory().getHelmet()));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment3 = new PacketPlayOutEntityEquipment(player.getEntityId(), 3, CraftItemStack.asNMSCopy(player.getInventory().getChestplate()));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment4 = new PacketPlayOutEntityEquipment(player.getEntityId(), 2, CraftItemStack.asNMSCopy(player.getInventory().getLeggings()));
        final PacketPlayOutEntityEquipment packetPlayOutEntityEquipment5 = new PacketPlayOutEntityEquipment(player.getEntityId(), 1, CraftItemStack.asNMSCopy(player.getInventory().getBoots()));
    ...
    public ItemStack getPlayerHead(final Player player, final ItemStack itemStack) {
        ...
        if (itemStack != null) {
            final net.minecraft.server.v1_8_R3.ItemStack nmsCopy = CraftItemStack.asNMSCopy(bukkitCopy);
    ...
    public void invisibilityFix(final Player obj, final IArena arena) {
        ...
        for (final Player player : arena.getPlayers()) {
            ...
            if (player.getLocation().distance(obj.getLocation()) > v1_8_R3.renderDistance) {
                continue;
            }
    ...
    public static class VillagerShop extends EntityVillager
    {
        ...
        public void collide(final net.minecraft.server.v1_8_R3.Entity entity) {
        }
