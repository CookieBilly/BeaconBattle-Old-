...
public class HikariProxyPreparedStatement extends ProxyPreparedStatement implements Wrapper, AutoCloseable, Statement, PreparedStatement
{
    ...
    @Override
    public void setLargeMaxRows(final long largeMaxRows) {
        try {
    ...
    HikariProxyPreparedStatement(final ProxyConnection proxyConnection, final PreparedStatement preparedStatement) {
